export default class Baseline {
    constructor(isMale = true, age = 23.0, height = 180.0, weight = 70.0, bfp = 18.0, rmr = 1708.0, pal = 1.6) {
        this.MAX_AGE = 250.0;
    ...
    getNewRMR(newWeight, day) {
        if (this.isMale)
            return 9.99 * newWeight + 625.0 * this.height / 100.0 - 4.92 * (this.age + day / 365.0) + 5.0;
        else
            return 9.99 * newWeight + 625.0 * this.height / 100.0 - 4.92 * (this.age + day / 365.0) - 161.0;
    }
    ...
    getECW() {
        if (this.isMale)
            return 0.025 * this.age + 9.57 * this.height + 0.191 * this.weight - 12.4;
        else
            return -4.0 + 5.98 * this.height + 0.167 * this.weight;
    }
    ...
    getNewECW(days, newWeight) {
        if (this.isMale)
            ...
            return -4.0 + 5.98 * this.height + 0.167 * newWeight;
    }
